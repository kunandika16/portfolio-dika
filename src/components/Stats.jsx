      ...
      <div className="max-w-6xl mx-auto px-4 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          <div className="flex flex-col items-center">
            ...
            <div className="text-slate-500 font-semibold uppercase tracking-widest text-sm">Years Experience</div>
          </div>
          <div className="flex flex-col items-center">
            <div className="text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-primary mb-3">
              500+
            </div>
            <div className="text-slate-500 font-semibold uppercase tracking-widest text-sm">Finished Projects</div>
          </div>
          <div className="flex flex-col items-center">
            <div className="text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-primary mb-3">
              100+
            </div>
            <div className="text-slate-500 font-semibold uppercase tracking-widest text-sm">Brands</div>
          </div>
        </div>
      </div>

      {/* Infinite Logo Slider */}
      <div className="w-full overflow-hidden flex flex-col justify-center bg-slate-50/50 py-12 border-y border-slate-100 relative">
        ...
        <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-slate-50/50 to-transparent z-10 pointer-events-none" />
